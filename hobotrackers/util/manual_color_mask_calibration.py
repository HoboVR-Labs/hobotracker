...
"""Methods and classes for finding objects in videos using color masks."""
...
class ColorRange(object):
    """A range for hsv colors to mask."""
    ...
    def __init__(
        ...
        """
        Create a range for hsv colors to mask.

        :param color_num: ID for this color
        """
...
class CalibrationData(object):
    """Calibration info including multiple color masks and camera settings."""
    ...
    def __init__(
        ...
        """
        Store calibration info including multiple color masks and camera settings.

        :param auto_exposure: camera auto exposure setting
        :param exposure: camera exposure setting
        :param saturation: camera saturation setting if supported
        :param num_colors: number of color masks we're using
        """
...
def get_color_mask(hsv, color_range: ColorRange):
    """Get a mask of the hsv input image using the specific color range."""
